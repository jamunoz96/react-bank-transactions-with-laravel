...
import { getPersonalAccounts, saveTransaction } from "../../../store/actions/transactionActions";


const TransactionsPersonal = () => {
    ...
    return (<>
        ...
        <p className="text-secondary">Transferir a cuentas propias</p>
        <br></br>
        <Card >
            <Card.Body>
                ...
                <Form
                    ...
                    <Form.Group>
                        ...
                        <Form.Control as="select"
                            ...
                            <option></option>
                            {accounts.personal && accounts.personal.map((account) => {
                                return (
                                    <option key={account.id} disabled={form.destine == account.id} value={account.id}> {account.number} </option>
                                );
                            })}
                        </Form.Control>
                    </Form.Group>
                    ...
                    <Form.Group>
                        ...
                        <Form.Control as="select"
                            ...
                            {accounts.personal && accounts.personal.map((account) => {
                                return (
                                    <option key={account.id} disabled={form.origin == account.id} value={account.id}> {account.number} </option>
                                );
                            })}
                        </Form.Control>
                    </Form.Group>
